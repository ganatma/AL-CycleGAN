...
MODEL_FILE=./checkpoints/${FILE}_pretrained/latest_net_G_B.pth
URL=http://efrosgans.eecs.berkeley.edu/cyclegan/pretrained_models/$FILE.pth

wget -N $URL -O $MODEL_FILE

MODEL_FILE=./checkpoints/${FILE}_pretrained/latest_net_D_A.pth
URL=http://efrosgans.eecs.berkeley.edu/cyclegan/pretrained_models/$FILE.pth

wget -N $URL -O $MODEL_FILE

MODEL_FILE=./checkpoints/${FILE}_pretrained/latest_net_D_B.pth
URL=http://efrosgans.eecs.berkeley.edu/cyclegan/pretrained_models/$FILE.pth
